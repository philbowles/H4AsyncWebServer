...
document.addEventListener("DOMContentLoaded", function() {
    ...
    source.addEventListener('ui', function(e){ console.warn("ui ",e.data); ui2(e.data) });
    source.onmessage=function(e){ console.warn("msg ",e.data); toaster(e.data) }
    source.onerror=function(e){ console.warn("error ",e); document.querySelectorAll('div.hanger').forEach((d) => d.style.background="#ff0000") }
    source.onopen=function(e){ console.warn("open ",e); document.querySelectorAll('div.hanger').forEach((d) => d.style.background="#ffffff") }
